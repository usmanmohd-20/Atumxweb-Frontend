...
export default function BookmarkIcon({ className, ...rest } : BookIconProps) {
  ...
  return (
    <svg className={className} width="34" height="39" viewBox="0 0 34 39" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1.5 3.5C1.5 2.39543 2.39543 1.5 3.5 1.5H27.1469C28.2514 1.5 29.1469 2.39543 29.1469 3.5V31.6701C29.1469 32.7747 28.2514 33.6701 27.1469 33.6701H7.5C4.18629 33.6701 1.5 30.9839 1.5 27.6701V3.5Z" fill={color}stroke={color} strokeWidth="3"/>
      ...
      <path d="M32.9867 3.41504V30.6065C33.1147 32.9043 32.3723 37.5001 28.3789 37.5001C24.3855 37.5001 12.6355 37.5001 7.25977 37.5001" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
